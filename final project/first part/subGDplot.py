...
from subGDclass import SVMClassification 
...
def train_and_plot(X_train, y_train, X_test, y_test, C, ax, regularizer):
    ...
    # Note: We can't plot support vectors as they're not explicitly stored in the new implementation
    ...
    print(f"  Weight vector norm: {np.linalg.norm(svm.w):.2f}")
